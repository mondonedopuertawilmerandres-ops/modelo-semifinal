...
que aun quedara pendiente. Es un paso informativo: Octavos ya se jugo por
completo, y el bracket de Semifinales (core/bracket.py) lee los clasificados
de Cuartos directamente del dato real, sin depender de esta tabla.
"""
import pandas as pd
